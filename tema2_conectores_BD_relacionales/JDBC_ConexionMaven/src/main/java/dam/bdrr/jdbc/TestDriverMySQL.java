...
public class TestDriverMySQL {
    ...
    public static void main(String[] args) {
        ...
        String mibase = "alumnos";
        try {
            // una sola cadena de conexión, en un sólo parámetro se concatena el
            // usuario y el password
            String url1 = "jdbc:mysql://localhost:3307/" + mibase + "?useSSL=false&serverTimezone=UTC&user=" + user + "&password=" + password;
            ...
            datos.put("root", user);
            datos.put("usbw", password);
            String url2 = "jdbc:mysql://localhost:3307/" + mibase+ "?useSSL=false&serverTimezone=UTC";
            ...
            String url3 = "jdbc:mysql://localhost:3307/" + mibase+ "?useSSL=false&serverTimezone=UTC";
