...
//        configuration.configure();
	              ...
	              
        {
            ...
            profesor1=(Profesor)session.get(Profesor.class,101);
            session.getTransaction().commit();
            session.close();

            session=sessionFactory.openSession();
            session.beginTransaction();
            profesor2=(Profesor)session.get(Profesor.class,101);
            session.getTransaction().commit();
            session.close();
        ...
        {   //Ahora hacemos lo mismo que hemos hecho con el profesor pero con el Usuario pero ahora si que irá bien
            ...
            //Se ha hecho un   @Override del equals en la clase Usuario
