package gal.mrnovoa.hibernate.hql;
...
// loads configuration and mappings
            ...
            if (session==null){
             ...
             System.out.println("\033[31m sesion open null");
            }
            // obtains the session
	...
	void closeSession() {
                 if (session==null){
             System.out.println("\"\\033[31m sesion close null");
	...
	public static void main(String[] args) {
		...
		try {
			demo.openSession();
//                        System.out.println("\033[34m"); 
//                       System.out.println("\033[31mSe establecio la conexion");
//                       
			demo.testListQuery();
...
//			demo.testUpdateQuery();
			...
			ex.printStackTrace();
			 ...
			 demo.closeSession();
                         System.out.println("\033[34m Bye"); 
		}
	}
}